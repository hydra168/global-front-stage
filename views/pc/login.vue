 ...
 */
const createComponentFunction = require.context('@LAYOUT/pc/Login', true, /.vue/);
...
function getImport(PC_LOGIN_TYPE) {
  switch (PC_LOGIN_TYPE) {
    ...
    case '4':
      return './Login-004/index.vue';
    case '5':
      return './Login-005/index.vue';
    case '6':
      return './Login-006/index.vue';
    case '7':
      return './Login-007/index.vue'; // 1159 亞博版
    case '8':
      return './Login-008/index.vue';
    default:
      return './Login-default/index.vue';
  }
}
export default {
  ...
  computed: {
    ...
    pcLoginType() {
      if (this.loginData) {
        return this.loginData['PC_LOGIN_TYPE'];
      } else {
        return '0';
      }
    },
