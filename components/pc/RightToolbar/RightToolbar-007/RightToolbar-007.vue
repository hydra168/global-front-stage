<template>
  <div id="RightToolbar" class="RightToolbar-007">
    <div class="position-set" :style="itemStyle">
      <template v-for="(item, i) in youshi">
        <div
          :key="i"
          class="item-wrap frozen-hover frozen2 d-flex flex-column justify-center pa-2 mb-3 rounded"
          v-bind="itemWrap"
          @click="item.func"
