<template>
  <aside class="Navbar-001" :class="color">
    <v-container pa-0 class="d-flex align-center" :class="[isShowLogo ? 'justify-space-between' : 'justify-space-around']">
      <img v-if="isShowLogo" :src="logoUrlHandler" :width="logoWidth" alt="logo" style="cursor: pointer" @click="ROUTER_PUSH('/')" />
      <div class="d-flex justify-space-around" :class="{ 'full-width': !isShowLogo }">
