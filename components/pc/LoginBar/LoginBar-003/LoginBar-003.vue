<template>
  <v-container class="LoginBar-003 ma-0 pa-0" fluid>
    <v-row align="center" class="pa-0 ma-0">
      ...
      <div class="d-flex" style="margin-left: auto">
          ...
          <v-row class="text-no-wrap" no-gutters xs12 align="center" justify="end">
            ...
            <v-menu :close-on-content-click="false" :open-on-hover="true" :top="false" offset-y max-width="30%">
              <template v-slot:activator="{ on }">
                ...
                >
                  {{ textFilter('balance') }} <v-icon small class="spinner">cached</v-icon>
                </v-btn>
              </template>
              <v-card>
                <v-list>
                  <v-list-item :key="i" v-for="(item, i) in balanceAllInfo">
        ...
        <!-- 選擇語系 -->
        <div class="ml-5 d-none d-md-flex d-lg-flex pa-0 ma-0 align-center">
          <v-select
            dense
            outlined
            hide-details
