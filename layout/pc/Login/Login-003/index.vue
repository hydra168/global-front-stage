<template>
  <div id="Login-page" class="Login-003">
    <video
    ...
    <v-card class="login-page-wrap" :style="staticBg">
      <v-container class="page">
        <v-card class="page-inner">
          <div class="boxes">
            <div class="box left-box pa-5" :class="{ isRegister: !isLoginMode }">
            ...
            <div class="box right-box pa-5" :class="{ isRegister: isLoginMode }">
...
.Login-003 ::v-deep .login-page-wrap {
