<template>
  <div id="Login-page" class="Login-default sky">
    <span class="shooting-star" v-for="n in 3" :key="n"></span>
    <span class="shooting-star shooting-star-curved" v-for="n in 3" :key="`curved-${n}`"></span>
    <span class="shooting-star shooting-star-flat" v-for="n in 3" :key="`flat-${n}`"></span>
    <video
          ...
          <div class="boxes">
            ...
            <div :class="`box right-box ${!isLoginMode ? 'isRegister' : ''}`">
              ...
              <div class="liveChatButton">
                <v-btn block rounded large depressed color="primary" :disabled="isLoading" @click="SHOW_LIVE_CHAT(0)">
              ...
              <div class="appDownloadButton">
                <v-menu :close-on-content-click="false" :open-on-hover="true" :top="false" offset-y max-width="30%">
                  <template v-slot:activator="{ on }">
                    <v-btn block rounded large depressed color="primary" :disabled="isLoading" v-on="on || true">
...
@import '@ASSETS/scss/shooting-stars.scss';
.Login-default ::v-deep .login-page-wrap {
