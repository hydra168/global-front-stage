            ...
            <v-card class="page-inner">
              ...
              <div class="boxes">
                ...
                <div :class="`box right-box ${!isLoginMode ? 'isRegister' : ''}`">
                  <div>
                    <v-btn class="customerColor" block large outlined :disabled="isLoading" @click="routerPush">
                      {{ textFilter(isLoginMode ? 'freeRegistration' : 'hasAccount') }}
                    </v-btn>
                  </div>
                  <div class="liveChatButton">
                    <v-btn class="customerColor" block large outlined :disabled="isLoading" @click="SHOW_LIVE_CHAT(0)">
                  ...
                  <div class="appDownloadButton">
                    <v-menu :close-on-content-click="false" :open-on-hover="true" :top="false" offset-y max-width="30%">
                      <template v-slot:activator="{ on }">
                        <v-btn class="customerColor" block large outlined :disabled="isLoading" v-on="on || true">
