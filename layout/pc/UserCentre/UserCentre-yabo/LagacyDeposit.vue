<template>
  ...
  <div id="Deposit" class="Deposit">
    ...
    <div class="d-flex flex-row-reverse justify-space-between mt-8">
      <v-btn color="primary" depressed @click="postDepositHandler" :disabled="!formValid">
    ...
    <!-- 提示區 -->
    <v-card color="grey lighten-3 grey--text text--darken-3" class="mt-5" v-if="payment.type !== '5'">
...
export default {
  ...
  computed: {
    ...mapGetters(['isLoading', 'config', 'paymentAccountList', 'depositOrderInfo', 'usdtAppChannels']),
    dialogFORM() {
