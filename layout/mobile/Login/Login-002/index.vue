<template>
  <v-container id="Login-page" class="m-login-page-wrap" :style="`background-image:url(${loginBgSrc})`">
    <img class="top-img" :src="loginTopImgSrc" />
    <v-card class="page-inner">
      ...
      <v-form ref="form">
        ...
        <div style="display: flex; justify-content: space-between">
          ...
          <v-btn rounded color="primary" class="liveChatButton" style="margin-top: 16px" @click="SHOW_LIVE_CHAT(0)">{{
...
import { MOBILE_LOGIN_BG_SRC, MOBILE_LOGIN_LOGO_SRC, MOBILE_LOGIN_TOP_IMG_SRC } from '@G/consts';
